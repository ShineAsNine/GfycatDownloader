...
@click.option("-j", "--json_file", prompt="JSON File", type=click.Path(exists=True))
...
def json_file(output_directory, output_template, json_file, gfy_type_to_download, sleep, overwrite):
    ...
    try:
        ...
        DownloadGfys(download_options, None).start_download()
